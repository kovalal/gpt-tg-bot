...
Я — ваш умный LLM-бот, который поддерживает не только текст, но и изображения, а также голосовой ввод! Вот что я умею:

<b>🛠 Доступные команды:</b>

<b>/start</b> – Запуск и ознакомление с функционалом.
<b>/help</b> – Список команд и подробные примеры использования.
<b>/settings</b> – Настройка параметров: выберите нужную модель и измените другие опции для максимального комфорта.
<b>💬 Функциональные возможности:</b>

<b>Текстовая обработка:</b> Задавайте вопросы и получайте развернутые ответы.
<b>Голосовой ввод и вывод:</b>
Отправляйте голосовые сообщения для команд.
В режиме <i>auto</i> попросите меня озвучить текст: <i>"Озвучь: Привет, как дела?"</i> 🔊
<b>Работа с изображениями:</b>
Генерирую изображения по вашим текстовым описаниям.
Принимаю изображения от вас для дальнейшей обработки или анализа. 🖼️
<b>📌 Примеры использования:</b>

<i>"Нарисуй волшебный лес на закате"</i> – я создам изображение по описанию.
<i>"Озвучь: Добро пожаловать в мир инноваций!"</i> – преобразую текст в аудио.
<i>"Настрой бот на другую модель через /settings"</i> – измените параметры для удобства.
Начните общение, и я с радостью помогу вам во всех вопросах! 🚀''',
        parse_mode="HTML"
    )
